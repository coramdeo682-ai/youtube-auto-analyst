...
# [설정] 페이지 기본 설정
# ==========================================
st.set_page_config(page_title="금융 인사이트 AI Pro (Ver 3.1)", page_icon="📈", layout="wide")
...
# [UI] 화면 구성 시작
# ==========================================
st.title("📈 금융 인사이트 AI Pro (Ver 3.1)")

# [확인용] 새 버전이 적용되었는지 알려주는 알림창 (실행되면 뜹니다)
st.toast("✅ V3.1 업데이트가 정상적으로 적용되었습니다!", icon="🚀")
...
# ------------------------------------------------------------------
with st.sidebar:
    # [수정 확인 포인트 1] 제목이 '데이터 제어 센터'여야 함
    st.title("🗂️ 데이터 제어 센터 (New)")
    
    st.markdown("### 📝 데이터 수동 입력")
    st.info("ChatGPT가 만든 JSON을 아래에 붙여넣으세요.")
    
    # [수정 확인 포인트 2] expander 없이 바로 입력창이 보여야 함
